    ...
    <article className={cn('companion-list', classNames)}>
      <h2 className="font-bold text-3xl">Recent Sessions</h2>
        <Table>
          ...
          <TableBody> 
            {/* ? is chaining op, meaning it makes sure companions is not null and not undefined before mapping, prevents throwing type error if that case is true */}
                  ...
                  <Link href={`/companions/${id}`}>
                    <div className="flex items-center gap-2">
                      ...
                      <div className="flex flex-col gap-2">
                        <p className="font-bolt text-2xl">{name}</p>
